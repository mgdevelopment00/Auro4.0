...
class Rotate_Request(metaclass=Metaclass_Rotate_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.direction = kwargs.get('direction', bool())
...
class Metaclass_Rotate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from auro_interfaces.srv import _rotate
...
class Rotate(metaclass=Metaclass_Rotate):
    from auro_interfaces.srv._rotate import Rotate_Request as Request
    from auro_interfaces.srv._rotate import Rotate_Response as Response
