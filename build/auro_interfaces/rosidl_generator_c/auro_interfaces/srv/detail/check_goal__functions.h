...
#ifndef AURO_INTERFACES__SRV__DETAIL__CHECK_GOAL__FUNCTIONS_H_
#define AURO_INTERFACES__SRV__DETAIL__CHECK_GOAL__FUNCTIONS_H_
...
/// Initialize srv/CheckGoal message.
/**
...
/// Finalize srv/CheckGoal message.
/**
...
/// Create srv/CheckGoal message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * auro_interfaces__srv__CheckGoal_Request__init().
...
/// Destroy srv/CheckGoal message.
/**
 * It calls
 * auro_interfaces__srv__CheckGoal_Request__fini()
...
/// Check for srv/CheckGoal message equality.
/**
...
/// Initialize array of srv/CheckGoal messages.
/**
...
/// Finalize array of srv/CheckGoal messages.
/**
 * It calls
 * auro_interfaces__srv__CheckGoal_Request__fini()
...
/// Create array of srv/CheckGoal messages.
/**
 * It allocates the memory for the array and calls
 * auro_interfaces__srv__CheckGoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CheckGoal messages.
/**
 * It calls
 * auro_interfaces__srv__CheckGoal_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CheckGoal message array equality.
/**
...
/// Copy an array of srv/CheckGoal messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * auro_interfaces__srv__CheckGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_auro_interfaces
...
/**
 * It calls
 * auro_interfaces__srv__CheckGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_auro_interfaces
...
/**
 * It allocates the memory for the array and calls
 * auro_interfaces__srv__CheckGoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_auro_interfaces
...
/**
 * It calls
 * auro_interfaces__srv__CheckGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AURO_INTERFACES__SRV__DETAIL__CHECK_GOAL__FUNCTIONS_H_
