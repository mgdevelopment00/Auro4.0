...
#ifndef AURO_INTERFACES__SRV__DETAIL__COLLISION__FUNCTIONS_H_
#define AURO_INTERFACES__SRV__DETAIL__COLLISION__FUNCTIONS_H_
...
/// Initialize srv/Collision message.
/**
...
/// Finalize srv/Collision message.
/**
...
/// Create srv/Collision message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * auro_interfaces__srv__Collision_Request__init().
...
/// Destroy srv/Collision message.
/**
 * It calls
 * auro_interfaces__srv__Collision_Request__fini()
...
/// Check for srv/Collision message equality.
/**
...
/// Initialize array of srv/Collision messages.
/**
...
/// Finalize array of srv/Collision messages.
/**
 * It calls
 * auro_interfaces__srv__Collision_Request__fini()
...
/// Create array of srv/Collision messages.
/**
 * It allocates the memory for the array and calls
 * auro_interfaces__srv__Collision_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Collision messages.
/**
 * It calls
 * auro_interfaces__srv__Collision_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Collision message array equality.
/**
...
/// Copy an array of srv/Collision messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * auro_interfaces__srv__Collision_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_auro_interfaces
...
/**
 * It calls
 * auro_interfaces__srv__Collision_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_auro_interfaces
...
/**
 * It allocates the memory for the array and calls
 * auro_interfaces__srv__Collision_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_auro_interfaces
...
/**
 * It calls
 * auro_interfaces__srv__Collision_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AURO_INTERFACES__SRV__DETAIL__COLLISION__FUNCTIONS_H_
